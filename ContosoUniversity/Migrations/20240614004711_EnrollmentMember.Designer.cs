...
namespace ContosoUniversity.Migrations
{
    ...
    [Migration("20240614004711_EnrollmentMember")]
    partial class EnrollmentMember
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ContosoUniversity.Models.Enrollment", b =>
                {
                    ...
                    b.Property<int?>("MembershipMemberID")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ContosoUniversity.Models.Membership", b =>
                {
            ...
            modelBuilder.Entity("ContosoUniversity.Models.Enrollment", b =>
                {
                    ...
                    b.HasOne("ContosoUniversity.Models.Membership", null)
                        .WithMany("Enrollments")
                        .HasForeignKey("MembershipMemberID");
            ...
            modelBuilder.Entity("ContosoUniversity.Models.Membership", b =>
                {
                    b.HasOne("ContosoUniversity.Models.Student", "Student1")
                        .WithMany("MembershipsAsStudent1")
                        .HasForeignKey("Student1ID")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("ContosoUniversity.Models.Student", "Student2")
                        .WithMany("MembershipsAsStudent2")
            ...
            modelBuilder.Entity("ContosoUniversity.Models.Student", b =>
                {
                    ...
                    b.Navigation("MembershipsAsStudent1");

                    b.Navigation("MembershipsAsStudent2");
                });
